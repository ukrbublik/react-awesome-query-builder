...
export const with_range_bad_dates = {
  and: [
    {
      "<=": ["2020-05-10TTTT", { var: "date" }, "2020-05-15T21:00:00.000Z"],
    },
  ],
};
...
export const with_select_and_multiselect = {
  and: [
    ...
    {
      all: [{ var: "multicolor" }, { in: [{ var: "" }, ["yellow", "green"]] }],
    },
  ],
};
...
export const with_struct_inside_group = {
  and: [
    {
      some: [{ var: "results" }, { "==": [{ var: "user.name" }, "ddd"] }],
    },
  ],
};
...
export const with_2_numbers = {
  and: [{ "==": [{ var: "num" }, 2] }, { "==": [{ var: "num" }, 3] }],
};

export const with_num_and_num2 = {
  and: [{ "==": [{ var: "num" }, 2] }, { "==": [{ var: "num2" }, 3] }],
};
...
export const with_multiselect = {
  and: [
    {
      all: [{ var: "multicolor" }, { in: [{ var: "" }, ["green", "orange"]] }],
    },
  ],
};
...
export const with_multiselecttree = {
  and: [
    {
      all: [{ var: "multiselecttree" }, { in: [{ var: "" }, ["2", "5"]] }],
    },
  ],
};
...
export const with_nested = {
  and: [{ "==": [{ var: "user.info.firstName" }, "abc"] }],
};
