...
It is a collection of JS functions and React components to be used in other parts of config by reference to `ctx` rather than by reference to imported modules. 
