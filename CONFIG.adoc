...
|fixJsonLogicDateCompareOp |true |Fix comparing of Date instances in JsonLogic by using custom ops `date==`/`datetime==` instead of `==`  and  `date1=`/`datetime!=` instead of `1=`
|===
