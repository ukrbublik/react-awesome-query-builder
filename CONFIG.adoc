...
|useGroupsAsArrays |false |See https://github.com/ukrbublik/react-awesome-query-builder/issues/246[issue]
|defaultGroupConjunction |`"OR"` |For use with `useGroupsAsArrays` (`OR` will translate to JsonLogic's `some`, `AND` - to `all`)
|===
