...
|fieldSettings.listValues |+ for (multi)select, tree (multi)select | |List of values for Select widget. +
...
|maxNumberOfRules |100 |Maximum number of rules which can be added to the query builder
