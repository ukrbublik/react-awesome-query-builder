...
import {getTitleInValueList, defaultValue, useOnPropsChanged} from "../../utils/stuff";
    ...
    if (isConst && defaultValue) {
        if (typeof defaultValue == "boolean") {
            ...
            if (Array.isArray(defaultValue))
                return defaultValue.map(v => getTitleInValueList(fieldSettings.listValues, v) || v).join(', ');
            else
                return (getTitleInValueList(fieldSettings.listValues, defaultValue) || defaultValue);  
        }
        return ""+defaultValue;
    }
