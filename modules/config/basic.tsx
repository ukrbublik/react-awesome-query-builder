...
const operators = {
  ...
  is_empty: {
    ...
    formatOp: (
      ...
      operatorOptions,
      isForDisplay
    ) => (isForDisplay ? `${field} IS EMPTY` : `!${field}`),
  ...
  is_not_empty: {
    ...
    formatOp: (
      ...
      operatorOptions,
      isForDisplay
    ) => (isForDisplay ? `${field} IS NOT EMPTY` : `!!${field}`),
...
const widgets = {
  ...
  boolean: {
    ...
    labelNo: "No",
    formatValue: (val, fieldDef, wgtDef, isForDisplay) =>
      isForDisplay ? (val ? "Yes" : "No") : JSON.stringify(!!val),
    sqlFormatValue: (val, fieldDef, wgtDef, op, opDef) => SqlString.escape(val),
    defaultValue: false,
    toJS: (val, fieldSettings) => val,
  },
  field: {
    ...
    formatValue: (
      ...
      opDef,
      rightFieldDef
    ) => (isForDisplay ? rightFieldDef.label || val : val),
    sqlFormatValue: (val, fieldDef, wgtDef, op, opDef, rightFieldDef) => val,
